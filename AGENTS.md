...
- `docs/results.md`: index of the results register. It and `docs/results/*.md` are generated
  by `just docs`; never edit any of them by hand.
...
- `docs/questions.md`: index of stable `Q-NNN` headings. Full conjectures and fidelity
  questions live in `docs/questions/*.md`.
